...
export interface ApiAdsLandingPageAdsLandingPage
  extends Struct.CollectionTypeSchema {
  collectionName: 'ads_landing_pages';
  info: {
    displayName: 'adsLandingPage';
    pluralName: 'ads-landing-pages';
    singularName: 'ads-landing-page';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    images: Schema.Attribute.Component<'image.image-array', false>;
    keyPoints: Schema.Attribute.Component<'points.points', true>;
    keyword: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::ads-landing-page.ads-landing-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiContactLeadContactLead extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    entryDateAndTime: Schema.Attribute.String;
    leadType: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    quoteDetails: Schema.Attribute.Text;
    selectedPackage: Schema.Attribute.String;
    subject: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHeroContentHeroContent extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    heroImageArray: Schema.Attribute.Media<'images', true> &
      Schema.Attribute.Required;
    heroTitleFirstLine: Schema.Attribute.String & Schema.Attribute.Required;
    heroTitleSecondLine: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiJobPostJobPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    location: Schema.Attribute.String;
    noOfOpenings: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::ads-landing-page.ads-landing-page': ApiAdsLandingPageAdsLandingPage;
